...
$page_title = "Admin Settings - COVID Portal";
?>
<!DOCTYPE html>
<html lang="en">
<head>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-primary"><?php echo ucfirst($user_data['role']); ?></span></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-grid gap-2">
                                                ...
                                                <a href="admin_patients.php" class="btn btn-outline-info btn-sm">
                                                    <i class="fas fa-users me-2"></i>Manage Patients
                                                </a>
                                                <a href="admin_hospitals.php" class="btn btn-outline-success btn-sm">
